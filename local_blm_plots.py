...
def main(i,j):
    ...
    inputsi = {'SVFlag': True,
               'contrasts': [{'c1': {'vector': [1],
                                     'statType': 'T',
                                     'name': 'contrast1'}}],
               'outdir': '/well/nichols/users/inf852/3000ukbbsv_mem' + str(i) + '_' + str(j) + '/', 
               'X': '/users/nichols/inf852/BLM-py/BLM/test/data/ukbb/X_ukbb_3000.csv', 
    ...
    shutil.rmtree('/well/nichols/users/inf852/3000ukbbsv_mem' + str(i) + '_' + str(j) + '/')
    np.savetxt('/well/nichols/users/inf852/t_mem' + str(i) + '_' + str(j) + '.csv',np.array([t]), delimiter=",") 
